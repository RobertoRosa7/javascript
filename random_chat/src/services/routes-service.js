...
(function(global, factory){
    ...
    */
    ...
    // sanitize options and default values
    Router.prototype._getSettings = function(options){
        ...
        var defaults = {
            ...
            page404:function(page){
                console.error({page:page, message:'404. Page not found'});
            }
        };
    ...
    // Convert string route to rule RegExp
    ...
    Router.prototype._pushHistory = function(){
       ...
       if(this.mode === 'hash'){
           if(this._historyState === 'add'){
               ...
               this._historyStack.push({ path: fragment, state: _this._pageState });
    ...
    // async request
    Router.prototype.unloadCallback = function(asyncRequest){
       var result;
    ...
    // check if route has action on current page
    ...
    Router.prototype._resetState = function(){
        ...
        this._navigateTo(this._currentPage, this._currentPage.state, true);
    }
